...
from task.ovrp.ovrp_task import OVRPTask
...
def main():
    ...
    ovrpTask = OVRPTask(n_instance=16, n_cities=50, capacity=50, seed=1234)
    ...
    method = GLNS(llm=llm,
                   task=ovrpTask,
                   profiler=ProfilerBase(log_dir='./logs/glns_ovrp', log_style='complex'),
                   max_generations=400,
                   pop_size=5,
                   prune_size=2,
                   check_timeout=10,
